...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="row">
                <form action="{{route('kolam.pdf.kecamatan')}}" method="GET" class="col-md-6">
                        <div class="panel">
                            <div class="panel-heading">
                ...
                <form class="col-md-6" action="{{route('kolam.excel.kecamatan')}}" method="GET">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Cetak Data Tabel</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <br>
                                <div class="text-center">
                                    <button class="btn btn-success" type="submit"><span class="lnr lnr-download"> </span>Export Excel</button>
                                    {{-- <a href="#" class="btn btn-success"><span class="lnr lnr-download"> </span>Export Excel</a> --}}
                    </div>
                </div>
            </div>
