...
<div class="main-content">
    <div class="container-fluid">
        <h3 class="page-title">Data Produksi Pengolahan</h3> @if ($message = Session::get('danger'))
        ...
        <form class="row" action="{{route('prolah.pdf.kecamatan')}}" method="GET">
                <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <h4></h4>
                                <p>Rincian data Produksi Pengolahan berdasarkan Bulan dan Kecamatan</p>
                                <br>
                                <div class="col-md-6">
        ...
        <form class="row" action="{{route('prolah.pdf.bulan')}}" method="GET">
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <h4></h4>
                        <p>Rekap data Produksi Pengolahan berdasarkan Bulan</p>
                        <br>
                        <div class="col-md-12">
                            <select class="form-control" name="bulan">
                                <option value="" disabled selected>--- Pilih Bulan ---</option>
