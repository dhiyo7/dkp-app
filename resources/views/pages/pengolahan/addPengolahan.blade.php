...
<div class="main-content">
    <div class="container-fluid">
        <h3 class="page-title">Input Data Produksi Pengolahan</h3>
                ...
                <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <div class="col-md-6">
                                        <input name="name" type="text" class="form-control" placeholder="Masukkan Nama" autofocus required><br>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <input name="produk_olahan" type="text" class="form-control" placeholder="Masukkan Produk Olahan"><br>
                                        <input name="produksi" type="number" class="form-control" placeholder="Masukkan Produksi"><br>
                                        <input name="nil_produksi" type="number" class="form-control" placeholder="Masukkan Nilai Produksi"><br>
                                        <textarea name="keterangan" class="form-control" placeholder="Keterangan ..." rows="4"></textarea><br>
                                </div>
                                <br>
                                <br>
